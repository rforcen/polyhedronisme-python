...
Johnsons johnsons = {
    {1, {{{1, 4, 2},    {0, 1, 2},    {3, 0, 2},    {4, 3, 2},    {4, 1, 0, 3}},
        {{-0.729665, 0.670121, 0.319155},    {-0.655235, -0.29213, -0.754096},
            {-0.093922, -0.607123, 0.537818},    {0.702196, 0.595691, 0.485187},
    ...
    {14,
        {{{4, 7, 6},
            ...
            {7, 4, 3, 5},
            {4, 2, 0, 3},
            {2, 7, 5, 0}}, {{-0.677756, 0.338878, 0.309352},
    ...
    {23,
        {{{1, 0, 2},
            ...
            {6, 12, 11, 5},
            {7, 6, 1, 2},
            {10, 4, 0, 3, 9, 15, 19, 16}}, {{-0.96917, 0.321358, -0.364138},
    ...
    {25,
        {{{2, 9, 11},
            ...
            {6, 7, 3, 0, 1},
            {8, 1, 2, 11, 14},
            {28, 23, 16, 9, 4, 5, 10, 17, 24, 29}}, {{-0.897802, -0.193467, -0.273331},
    ...
    {27, {{{2, 5, 8},
        ...
        {3, 6, 4, 0},
        {9, 3, 1, 7},
        {6, 9, 11, 10}}, {{-0.96936, 0.238651, 0.058198},
    ...
    {28, {{{3, 0, 2},
        ...
        {12, 6, 7, 13},
        {10, 12, 15, 14},
        {4, 10, 8, 2}}, {{-1.055402, 0.383836, -0.00011},
    ...
    {29,
        {{{4, 0, 1},
            ...
            {9, 3, 2, 8},
            {11, 9, 14, 15},
            {5, 11, 13, 6}}, {{-1.105, -0.077473, -0.184867},
    ...
    {30,
        {{{4, 0, 1},
            ...
            {3, 9, 5, 1},
            {7, 4, 10, 16, 13},
            {3, 6, 12, 15, 9}}, {{-1.197125, -0.118752, -0.001762},
    ...
    {31, {{{4, 0, 1},
        ...
        {6, 12, 10, 3},
        {7, 4, 8, 14, 13},
        {6, 5, 11, 15, 12}}, {{-1.14213, -0.353364, -0.133745},
    ...
    {32,
        {{{3, 0, 2},
            ...
            {17, 20, 16, 7, 8},
            {10, 8, 2, 0, 4},
            {11, 4, 1, 6, 13}}, {{-1.086754, 0.270723, -0.02221},
    ...
    {33,
        {{{5, 6, 11},
            ...
            {22, 23, 15, 11, 14},
            {18, 14, 6, 2, 10},
            {16, 10, 1, 4, 12}}, {{-0.799512, 0.192706, 0.001565},
    ...
    {34,
        {{{15, 7, 14},
            ...
            {16, 22, 28, 26, 19},
            {9, 19, 20, 11, 6},
            {2, 6, 5, 1, 0}}, {{-0.976027, 0.021192, 0.216616},
    ...
    {35,
        {{{9, 16, 12},
            ...
            {13, 10, 14, 17},
            {17, 14, 11, 15},
            {15, 11, 4, 7}}, {{-0.903332, -0.063468, 0.034076},
    ...
    {36,
        {{{3, 11, 9},
            ...
            {10, 12, 17, 16},
            {16, 17, 15, 13},
            {13, 15, 7, 5}}, {{-0.82124, -0.196132, -0.329082},
    ...
    {37,
        {{{2, 3, 0},
            ...
            {9, 16, 21, 5},
            {5, 21, 23, 1},
            {1, 23, 22, 0}}, {{-0.862856, 0.357407, -0.357407},
    ...
    {38, {{{17, 10, 19},
        ...
        {28, 25, 20, 22},
        {12, 17, 24, 23, 15},
        {9, 4, 8, 16, 18}}, {{-1.047541, -0.14473, -0.164687},
    ...
    {39,
        {{{11, 4, 13},
            ...
            {28, 29, 25, 24},
            {6, 11, 19, 20, 12},
            {17, 9, 10, 18, 23}}, {{-1.006864, 0.217224, -0.290603},
    ...
    {40,
        {{{6, 1, 8},
            ...
            {25, 15, 13, 23, 30},
            {32, 30, 31, 33, 34},
            {28, 34, 29, 22, 21}}, {{-1.05518, -0.061289, -0.047893},
    ...
    {41,
        {{{9, 3, 10},
            ...
            {26, 19, 22, 29, 33},
            {31, 33, 34, 32, 28},
            {23, 28, 24, 14, 13}}, {{-1.045033, 0.161365, 0.036367},
    ...
    {42,
        {{{0, 3, 4},
            ...
            {38, 32, 28, 31, 37},
            {39, 37, 33, 29, 35},
            {36, 35, 26, 20, 27}}, {{-1.094229, 0.091579, -0.183298},
    ...
    {43,
        {{{0, 2, 1},
            ...
            {38, 31, 26, 29, 37},
            {39, 37, 32, 30, 35},
            {36, 35, 27, 23, 28}}, {{-1.099924, -0.170755, -0.018241},
    ...
    {44,
        {{{11, 14, 6},
            ...
            {10, 9, 15, 16},
            {3, 10, 8, 2},
            {9, 3, 1, 7}}, {{-0.789003, 0.385273, -0.254111},
    ...
    {45,
        {{{13, 16, 20},
            ...
            {10, 14, 7, 3},
            {17, 10, 6, 11},
            {21, 17, 19, 23}}, {{-0.984615, -0.215433, 0.042813},
    ...
    {46,
        {{{9, 11, 18},
            ...
            {24, 26, 29, 27},
            {2, 9, 16, 10, 3},
            {24, 17, 15, 21, 26}}, {{-0.962816, 0.187793, 0.445444},
    ...
    {47,
        {{{8, 12, 18},
            ...
            {27, 17, 9, 14, 25},
            {32, 25, 22, 26, 33},
            {34, 33, 29, 28, 31}}, {{-0.908535, -0.523787, -0.144699},
    ...
    {48,
        {{{0, 5, 1},
            ...
            {39, 33, 27, 29, 34},
            {38, 34, 28, 26, 32},
            {36, 32, 24, 22, 30}}, {{-1.023844, 0.34935, 0.211966},
    ...
    {49,
        {{{6, 3, 2},
            ...
            {6, 4, 3},
            {2, 0, 1, 5},
            {5, 1, 4, 6}}, {{-0.87547, -0.255205, -0.086794},
    ...
    {50,
        {{{3, 0, 1},
            ...
            {7, 3, 5},
            {1, 5, 3},
            {0, 4, 6, 2}}, {{-0.878027, -0.44614, 0.176652},
    ...
    {51,
        {{{1, 5, 0},
            ...
            {0, 2, 1},
            {2, 6, 1},
            {1, 6, 5}}, {{-0.837735, -0.140456, -0.298855},
    ...
    {52,
        {{{3, 8, 4},
            ...
            {0, 2, 7, 5},
            {0, 1, 3, 4, 2},
            {7, 10, 9, 6, 5}}, {{-0.81481, 0.221521, -0.662951},
    ...
    {53,
        {{{2, 3, 0},
            ...
            {1, 0, 7, 8},
            {4, 5, 2, 0, 1},
            {8, 7, 9, 11, 10}}, {{-0.736376, 0.261231, -0.409511},
    ...
    {54,
        {{{5, 10, 9},
            ...
            {0, 3, 6, 2},
            {0, 1, 5, 9, 7, 3},
            {11, 12, 8, 4, 2, 6}}, {{-0.973522, 0.38842, -0.100967},
    ...
    {55,
        {{{12, 13, 11},
            ...
            {3, 6, 4, 1},
            {5, 9, 12, 11, 6, 3},
            {4, 8, 10, 7, 2, 1}}, {{-1.129559, 0.266324, 0.624401},
    ...
    {56,
        {{{3, 0, 1},
            ...
            {12, 10, 11, 13},
            {12, 8, 3, 1, 5, 10},
            {6, 2, 4, 9, 13, 11}}, {{-1.111755, 0.435562, -0.458586},
    ...
    {57,
        {{{9, 14, 11},
            ...
            {0, 2, 5, 3},
            {0, 4, 9, 11, 8, 2},
            {10, 13, 12, 7, 3, 5}}, {{-0.902174, -0.044182, -0.142406},
    ...
    {58,
        {{{2, 0, 5},
            ...
            {4, 6, 3, 0, 1},
            {13, 14, 9, 3, 6},
            {3, 9, 10, 5, 0}}, {{-0.906673, 0.136106, 0.246909},
    ...
    {59,
        {{{0, 7, 3},
            ...
            {20, 19, 15, 13, 17},
            {16, 10, 9, 15, 19},
            {15, 9, 3, 7, 13}}, {{-0.987924, -0.168105, -0.565605},
    ...
    {60,
        {{{7, 13, 15},
            ...
            {14, 19, 21, 16, 11},
            {17, 18, 20, 21, 19},
            {21, 20, 15, 13, 16}}, {{-0.858966, -0.256781, -0.362035},
    ...
    {61,
        {{{6, 3, 1},
            ...
            {16, 13, 5, 3, 11},
            {15, 9, 2, 5, 13},
            {2, 0, 1, 3, 5}}, {{-0.875027, -0.215344, -0.354115},
    ...
    {62,
        {{{6, 3, 0},
            ...
            {7, 3, 6},
            {1, 3, 7, 9, 5},
            {2, 5, 9, 8, 4}}, {{-0.821855, 0.223834, -0.340481},
    ...
    {63,
        {{{0, 4, 6},
            ...
            {6, 8, 7, 5, 2},
            {0, 2, 5, 3, 1},
            {7, 8, 4, 1, 3}}, {{-0.799898, 0.494585, -0.153719},
    ...
    {64,
        {{{6, 5, 8},
            ...
            {8, 4, 1, 3, 7},
            {6, 7, 3, 0, 2},
            {1, 4, 5, 2, 0}}, {{-0.777985, -0.188235, -0.285228},
    ...
    {65,
        {{{12, 7, 11},
            ...
            {11, 7, 2, 0, 5, 10},
            {13, 10, 5, 1, 3, 9},
            {3, 1, 0, 2, 4, 6}}, {{-0.91403, 0.409064, -0.602734},
    ...
    {66,
        {{{24, 16, 17},
            ...
            {4, 6, 7, 5, 3, 1, 0, 2}}, {{-0.935384, 0.507278, -0.272116},
    ...
    {67,
        {{{22, 25, 17},
            ...
            {10, 8, 5, 2, 0, 1, 4, 7}}, {{-0.85468, -0.304544, 0.321795},
    ...
    {68,
        {{{34, 30, 24},
            ...
            {27, 37, 46, 48, 42, 35, 25, 18, 14, 20}}, {{-1.053731, -0.062801, 0.140871},
    ...
    {69,
        {{{4, 8, 12},
            ...
            {52, 42, 38, 40, 46, 57, 65, 68, 66, 62}}, {{-0.988041, 0.082361, -0.032394},
    ...
    {70,
        {{{41, 46, 53},
            ...
            {31, 20, 13, 10, 12, 19, 29, 36, 45, 38}}, {{-0.989194, -0.091477, -0.102373},
    ...
    {71,
        {{{70, 73, 74},
            ...
            {46, 36, 23, 12, 9, 14, 26, 38, 47, 50}}, {{-0.942902, 0.07027, -0.149675},
    ...
    {72,
        {{{48, 45, 55},
            ...
            {6, 8, 18, 23, 16},
            {36, 48, 49, 39, 29},
            {10, 12, 24, 30, 20}}, {{-0.976612, 0.213547, -0.025026},
    ...
    {73,
        {{{36, 33, 44},
            ...
            {0, 4, 10, 9, 3},
            {24, 36, 47, 39, 25},
            {12, 23, 35, 34, 20}}, {{-0.984691, 0.125192, 0.121281},
    ...
    {74,
        {{{31, 25, 37},
            ...
            {0, 6, 10, 7, 1},
            {19, 31, 43, 39, 27},
            {16, 28, 40, 32, 20}}, {{-0.966046, -0.051368, 0.253213},
    ...
    {75,
        {{{30, 24, 37},
            ...
            {2, 9, 13, 11, 3},
            {18, 30, 40, 34, 21},
            {20, 29, 42, 38, 25}}, {{-0.980376, -0.197048, -0.005857},
    ...
    {76,
        {{{26, 17, 18},
            ...
            {31, 26, 35, 44, 41},
            {21, 30, 25, 13, 10},
            {41, 47, 50, 43, 33, 22, 14, 12, 20, 31}}, {{-0.975594, -0.152802, -0.163647},
    ...
    {77,
        {{{27, 16, 19},
            ...
            {32, 27, 36, 44, 42},
            {21, 28, 25, 13, 10},
            {42, 50, 51, 43, 33, 23, 15, 14, 22, 32}}, {{-0.965273, -0.178368, -0.195819},
    ...
    {78,
        {{{29, 19, 26},
            ...
            {31, 29, 40, 49, 42},
            {15, 25, 23, 13, 5},
            {42, 46, 43, 34, 24, 14, 8, 12, 21, 31}}, {{-0.969175, 0.215371, -0.127391},
    ...
    {79,
        {{{7, 17, 16},
            ...
            {0, 4, 6, 5, 1},
            {43, 48, 54, 53, 47},
            {1, 3, 10, 14, 22, 21, 13, 9, 2, 0}}, {{-1.035663, 0.17951, 0.161516},
    ...
    {80,
        {{{12, 10, 4},
            ...
            {28, 36, 44, 49, 48, 42, 34, 25, 19, 22}}, {{-0.981435, -0.157408, -0.109585},
    ...
    {81,
        {{{35, 29, 25},
            ...
            {47, 49, 48, 46, 41, 37, 32, 34, 39, 44}}, {{-0.91554, -0.17156, 0.190699},
    ...
    {82,
        {{{25, 23, 15},
            ...
            {41, 46, 48, 49, 47, 45, 40, 35, 33, 36}}, {{-0.915244, -0.149547, 0.004878},
    ...
    {83,
        {{{25, 27, 17},
            ...
            {36, 38, 40, 42, 44, 43, 41, 39, 37, 35}}, {{-0.932936, 0.189273, 0.192295},
    ...
    {84,
        {{{6, 7, 3},
            ...
            {6, 2, 4},
            {2, 6, 0},
            {0, 6, 3}}, {{-0.768016, 0.559678, 0.635844},
    ...
    {85,
        {{{13, 9, 14},
            ...
            {14, 10, 15},
            {13, 11, 4, 6},
            {2, 5, 10, 8}}, {{-0.984789, 0.388776, -0.318546},
    ...
    {86,
        {{{7, 3, 2},
            ...
            {6, 7, 2},
            {1, 0, 4, 5},
            {5, 4, 8, 9}}, {{-1.10165, -0.110367, -0.010645},
    ...
    {87,
        {{{5, 0, 1},
            ...
            {6, 2, 0},
            {0, 2, 1},
            {5, 1, 4, 7}}, {{-0.858193, -0.792464, 0.432564},
    ...
    {88,
        {{{6, 7, 10},
            ...
            {2, 0, 1},
            {7, 5, 9, 10},
            {4, 9, 5, 0}}, {{-0.710639, -0.297668, -0.15267},
    ...
    {89,
        {{{9, 8, 13},
            ...
            {8, 7, 12, 13},
            {3, 6, 12, 7},
            {5, 6, 3, 0}}, {{-0.83117, 0.133549, -0.011648},
    ...
    {90,
        {{{13, 6, 7},
            ...
            {15, 13, 12, 14},
            {5, 2, 0, 3},
            {3, 0, 4, 8}}, {{-1.052782, 0.264006, 0.098264},
    ...
    {91,
        {{{11, 13, 12},
            ...
            {11, 12, 8, 3, 4},
            {5, 7, 4, 0, 1},
            {10, 5, 1, 2, 9}}, {{-0.932446, -0.071511, 0.062428},
    ...
    {92,
        {{{12, 11, 4},
            ...
            {8, 13, 17, 14, 9},
            {16, 10, 3, 7, 14},
            {1, 4, 6, 5, 2, 0}}, {{-0.748928, 0.557858, -0.030371},
